...
///
/// 
/// This is the main class that setup the class for discord bot.  
/// 
namespace _02_commands_framework
{
    ...
    class Program
    {
        ...
        /// <summary>
        /// This is the MainAsync. 
        /// It sets up main services for the bots. 
        /// </summary>
        /// <returns></returns>
        public async Task MainAsync()
        {
            ...
            using (var services = ConfigureServices())
            {
                ...
                await client.LoginAsync
                    (TokenType.Bot, Utilities.Stuff.GetBotToken()
                    );
